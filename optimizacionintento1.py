...
def paso_metropolis(p0, prior_params, datos, L_0, posterior_p0, a, error=1, d=0.05, modelo=0):
...
def monte_carlo(p0, prior_params, N, datos, error=1, d=0.05, modelo=0):
    ...
    chi_cuad[0] = L_0[1]
    for i in range(1, N):
        P_M = paso_metropolis(muestra_met[i-1], prior_params, datos, L_0, posterior_p0, a, error, d, modelo)
        muestra_met[i] = P_M[0]
        L_0 = P_M[1], P_M[2]
        chi_cuad[i] = P_M[2]
        a = P_M[3]
